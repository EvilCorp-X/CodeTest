...
proxieList = open("prox.txt", "r").readlines()
...
def crack_file(method):
	...
	print(
		"\033[92m[\033[37m*\033[92m] \033[37mExample: If your File's Data is as: \033[92m10000xxxxxd|Rahat Khan\033[37m Then enter: \033[92muid|name\033[37m")
	filePattern = input(
