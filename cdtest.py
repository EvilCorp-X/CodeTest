...
def logo():
    ...
    print("\033[94m│    \033[92m▘  ▗▄▘▀▀▘▘ ▘▝▀ ▘  ▗▄▘▌   ▀ ▝▀ ▘  \033[94m   │".center(column1))
    print("\033[94m│                                        │".center(column2))
    print("\033[94m│ \033[95mAuthor : EvilSoul-X .                  \033[94m│".center(column1))
    print("\033[94m│ \033[95mTool   : Encode Python2 and Python3    \033[94m│".center(column1))
    print("\033[94m│ \033[95mGitHub : https://github.com/EvilSoul-X \033[94m│".center(column1))
    print("\033[94m│ \033[95mCoder  : EvilSoul-X               \033[37mV3.0 \033[94m│".center(column3))
    print("\033[94m└────────────────────────────────────────┘".center(column2))
...
def get_new_key(key_list):
    ...
    key = "Evil-Cloner@533e385e52" + str(code) + "^!"
    if (key in key_list):
...
def check_permission():
    logo()
    print("\n\033[92m   EVIL CLONER is Paid Tool. Checking Approval")
    # get approved key list
    k3y_list = requests.get("https://github.com/EvilSoul-X/personal/blob/main/CodeTest.txt").text
...
marshalHead = "# Encoded By PyEnc\n# A Product Of ToxicNoob\n# https://github.com/EvilSoul-X\n\nimport marshal\nexec(marshal.loads("
...
def encodeMarshal(data, power):
    ...
    for i in range(power):
        code = compile(powerData, "EvilSoul-X", "exec")
...
def saveFile(encData):
    ...
    savePath = "/sdcard/PyEnc/" + savefileName
...
def encode(type):
    ...
    psb("\033[92m    [\033[37m*\033[92m]\033[37m Saved File Path: \033[92m/sdcard/PyEnc/" + fileName.replace(".py", "_enc.py") + " \033[37m\n")
...
def update():
    ...
    try:
        mainVersion = requests.get("https://github.com/EvilSoul-X/PyEnc/blob/main/.version").text
    except:
    ...
    if (toolVersion == mainVersion):
        ...
        os.system("cd .. && rm -rf PyEncryptor && git clone https://github.com/EvilSoul-X/PyEnc > /dev/null 2>&1")
        ...
        time.sleep(1)
        os.system("cd .. && cd PyEnc && python PyEnc.py")
